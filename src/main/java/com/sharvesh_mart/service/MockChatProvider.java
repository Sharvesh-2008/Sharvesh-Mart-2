package com.sharvesh_mart.service;
...
public class MockChatProvider implements ChatProvider {
    ...
    public MockChatProvider() {
        faqResponses.put("shipping", "ðŸšš **Shipping & Delivery Info**:\nSharveshMart offers standard delivery (3-5 business days) across India. Free shipping is automatically applied on orders over â‚¹1,000!");
        faqResponses.put("delivery", "ðŸšš **Shipping & Delivery Info**:\nStandard shipping takes 3-5 business days. You can track live delivery status under 'My Order History'.");
        faqResponses.put("return", "ðŸ”„ **Return & Refund Policy**:\nYou can request a return within 7 days of receiving your item. Contact the seller directly or file a request via your Order History tab.");
        faqResponses.put("refund", "ðŸ’° **Refund Process**:\nRefunds are processed within 2-4 business days back to your original payment method after seller inspection.");
        faqResponses.put("payment", "ðŸ’³ **Payment Methods**:\nSharveshMart supports Credit/Debit cards, Net Banking, UPI, and Cash on Delivery (COD) via our secure mock checkout step.");
        faqResponses.put("coupon", "ðŸŽŸï¸ **Promo Codes & Coupons**:\nApply promo code `SHARVESH10` for 10% off (up to â‚¹5,000) or `WELCOME20` for 20% off directly in your Shopping Cart!");
        faqResponses.put("discount", "ðŸ·ï¸ **Discounts & Offers**:\nCheck our home page for featured products on discount, or enter `SHARVESH10` at cart checkout for an instant 10% discount!");
        faqResponses.put("track", "ðŸ“¦ **Order Tracking**:\nLog in to your account and open the 'My Order History' tab to view real-time status and download GST invoices.");
        faqResponses.put("seller", "ðŸª **Become a Seller**:\nTo start selling on SharveshMart, register an account as a 'Seller'. You can list products, set stock, set prices, and fulfill customer orders!");
        faqResponses.put("warranty", "ðŸ›¡ï¸ **Product Warranty**:\nMost electronic items and laptops listed by verified sellers come with a 1-year manufacturer warranty detailed on each product card.");
        faqResponses.put("admin", "ðŸ›¡ï¸ **Admin Supervision**:\nPlatform administrators oversee user accounts, moderate listings, and export detailed CSV reports under the Admin Control Panel.");
        faqResponses.put("invoice", "ðŸ§¾ **GST Invoices**:\nYou can view and print GST-compliant invoices for any past purchase directly from your 'My Order History' section!");
        faqResponses.put("contact", "âœ‰ï¸ **Customer Support**:\nYou can send direct messages to sellers on product pages or email our administrative team at `admin@SharveshMart.com`.");
    }

    @Override
    public String getReply(String userMessage, String context) {
        if (userMessage == null || userMessage.trim().isEmpty()) {
            return "Hello! I am your SharveshMart AI Shopping Assistant. How can I help you today with products, orders, shipping, or payments?";
        }
