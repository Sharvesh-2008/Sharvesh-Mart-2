    ...
    public String getReply(String userMessage, String context) {
        ...
        if (effectiveKey == null || effectiveKey.trim().isEmpty()) {
            return "ðŸ¤– **SharveshMart Assistant**:\n*Note: Gemini API Key is not configured on server. Operating in fallback mode.*\n\n" +
                   "I can assist you with order status, returns, delivery options, and promo codes on SharveshMart!";
        }
        ...
        try {
            ...
            String systemPrompt = "You are the official AI Assistant for SharveshMart, a multi-seller e-commerce marketplace. " +
