...
public class ChatService {
    ...
    public String processChat(String userMessage, String sessionId) {
        ...
        if (userMessage == null || userMessage.trim().isEmpty()) {
            return "Please type a valid question about SharveshMart products or services.";
        }
        if (userMessage.length() > 300) {
            return "âš ï¸ Question is too long. Please shorten your message to under 300 characters.";
        }
        ...
        synchronized (timestamps) {
            ...
            if (timestamps.size() >= 10) {
                return "â±ï¸ **Rate Limit Exceeded**: You have sent too many messages. Please wait a minute before asking another question (Limit: 10 msg/min).";
            }
            timestamps.add(now);
        }
        ...
        String domainContext = "SharveshMart Marketplace context: Multi-seller platform selling Laptops, Mobiles, Electronics, and Fashion with standard 3-5 day shipping and 7-day returns.";
