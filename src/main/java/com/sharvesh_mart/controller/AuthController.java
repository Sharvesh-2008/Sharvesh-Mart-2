package com.sharvesh_mart.controller;

import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;

import com.sharvesh_mart.dao.UserDao;
import com.sharvesh_mart.model.AuthResponse;
import com.sharvesh_mart.model.LoginRequest;
import com.sharvesh_mart.model.RegisterRequest;
...
/**
 * Spring Boot REST Controller handling user registration, login, and user management for SharveshMart.
 */
@RestController
@RequestMapping("/api")
@CrossOrigin(origins = "*")
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> register(@RequestBody RegisterRequest request) {
        ...
        try {
            ...
            AuthResponse response = new AuthResponse(true, "Registration successful! Welcome to SharveshMart.", newUser, token);
