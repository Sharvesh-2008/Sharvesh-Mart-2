...
/**
 * Data Access Object (DAO) for Coupon validation and discount calculations in SharveshMart.
 */
public class CouponDao {
    ...
    public Map<String, Object> validateAndApply(String code, double orderTotal) {
        ...
        if (orderTotal < coupon.getMinOrderAmount()) {
            return Map.of("valid", false, "message", "Minimum order amount of â‚¹" + coupon.getMinOrderAmount() + " required for this coupon.");
        }
        ...
        return Map.of(
            ...
            "message", "Coupon '" + coupon.getCode() + "' applied! Discount: â‚¹" + calculatedDiscount
        );
    }
}
