...
public class MockChatProvider implements ChatProvider {
    ...
    public MockChatProvider() {
        faqResponses.put("shipping", "🚚 **Shipping & Delivery Info**:\nSharveshMart offers standard delivery (3-5 business days) across India. Free shipping is automatically applied on orders over ₹1,000!");
        ...
        faqResponses.put("coupon", "🎟️ **Promo Codes & Coupons**:\nApply promo code `SHARVESH10` for 10% off (up to ₹5,000) or `WELCOME20` for 20% off directly in your Shopping Cart!");
