...
### 2. Run SHARVESHMART Application
```bash
mvn spring-boot:run
```
...
- **Admin**: `admin@SHARVESHMART.com` | Password: `Admin@123`
- **Seller**: `seller@SHARVESHMART.com` | Password: `Seller@123`
- **Buyer**: `buyer@SHARVESHMART.com` | Password: `Buyer@123`
