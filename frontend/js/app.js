...
class SHARVESHMARTApp {
    ...
    async submitRegister(event) {
        ...
        try {
            ...
            btn.disabled = false;
            btn.innerHTML = '<span>Create SHARVESHMART Account</span> <i class="fa-solid fa-circle-check"></i>';
        }
    }
        ...
        body.innerHTML = `
            <div class="invoice-box">
                <div class="invoice-header-row">
                    <div class="invoice-brand">Sharvesh<span>Mart</span></div>
    ...
    exportUsersCSV() {
        ...
        this.downloadCSV(csv, 'SHARVESHMART_users_report.csv');
    ...
    exportOrdersCSV() {
        ...
        this.downloadCSV(csv, 'SHARVESHMART_orders_report.csv');
...
document.addEventListener('DOMContentLoaded', () => {
    window.app = new SHARVESHMARTApp();
});
